...
public record BlastResistanceCondition(Comparison comparison, double compareTo) implements BlockCondition {
	...
	@Override
	public boolean test(@NotNull Level level, @NotNull BlockPos pos) { return this.comparison.compare(level.getBlockState(pos).getBlock().getExplosionResistance(), this.compareTo); }
}
